...
const CardDeal = () => (
  ...
  <h2><li >CONTACT US FOR YOUR BOOKING REQUEST</li>
  Send in your request via call/whatsapp or at our office.
  

  </h2>
  <li className={styles.heading2}>2</li>
  <li style={bold}>We Process Your item(s).
    We confirm receipt, process payment,& package your item(s) accordingly & 
